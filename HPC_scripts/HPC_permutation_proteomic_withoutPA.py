...
#Load dataset
df = pd.read_csv('proteomics_withoutPA/Data/Su_COVID_proteomics_processed_commoncases.csv', index_col=0)
...
with open('proteomics_withoutPA/Results'+folder_num+'/Run'+index_num + '.txt', "wb") as file:  
