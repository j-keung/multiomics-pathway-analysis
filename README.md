...
The scripts in this repository analyse the proteomic and metabolomic datasets from a recent paper by Su et al. studying COVID using various omics datasets, which can be accessed at: <br/>
Multi-Omics Resolves a Sharp Disease-State Shift between Mild and Moderate COVID-19 (Su et al., 2020) <br/>
